...
export default function MoreCard({ onOpen }) {
  return (
    <motion.button
      ...
      className="w-full bg-card border border-border rounded-2xl flex flex-col items-center justify-center py-4 hover:border-primary/40 transition-colors cursor-pointer min-h-[10rem]"
    >
